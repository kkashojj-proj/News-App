...
public class MainActivity extends AppCompatActivity implements DoWork.IData,DoWorkForImage.IData2 {
    Spinner spinner;
    ImageButton ib1,ib2,ib3,ib4;
    Button btn_get_news,btn_finish;
    LinearLayout ll_main,ll_scroll;
    final static String key="88b9d8e7d964457daa32c9d41ed66bbc";
    ImageView iv;
    ...
    public void displayArticle(Article a){
        ...
        new DoWorkForImage(MainActivity.this).execute(a.url_to_img);
